...
import br.ufpe.cin.if1001.rss.util.DownloadIntentService;
...
public class MainActivity extends Activity {
    ...
    protected void onStart() {
        ...
        ///Intent Service
        Intent download = new Intent(getApplicationContext(),DownloadIntentService.class);
        download.putExtra("url",linkfeed);
...
// OnResume e OnPause para Registrar e cancelar o registro dinamico

    protected void onResume(){

        IntentFilter intentFilter = new IntentFilter(DownloadIntentService.RSS_READY);
        LocalBroadcastManager.getInstance(getApplicationContext()).registerReceiver(bcReceiver,intentFilter);
        super.onResume();
    }

    protected void onPause(){

        LocalBroadcastManager.getInstance(getApplicationContext()).unregisterReceiver(bcReceiver);
        super.onPause();
    }
...
/* APAGAR AsyncTask desnecessaria
    */
